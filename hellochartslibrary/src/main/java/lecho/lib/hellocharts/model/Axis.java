...
public class Axis {
	...
	private boolean hasAxisLines =false;
	...
	public Bitmap getAxisBitmap() {
		return axisBitmap;
	}

	public void setAxisBitmap(Bitmap axisBitmap) {
		this.axisBitmap = axisBitmap;
	}
	...
	public void setDashPath(boolean dashPath) {
		hasLines=true;
		isDashPath = dashPath;
	}

	private boolean isDashPath=false;
	...
	public boolean hasAxisLines() {
		return hasAxisLines;
	}
	
	public Axis setHasAxisLines(boolean hasLines) {
		this.hasAxisLines = hasLines;
		return this;
	}
...
//	 * 16.7.21
//	 */
//	public Axis setLeftMarigen(int dp){
//		
//	}
//	
//	public int getLeftMarigen(){
//		
//	}
}
